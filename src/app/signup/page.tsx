    ...
    <div className="flex min-h-screen items-center justify-center bg-white px-4">
        <div className="w-full max-w-sm space-y-6 ">
            ...
            <form action={formAction} className="space-y-6">
                ...
                <button disabled={isPending} className="w-full rounded-md bg-black text-white text-sm py-2 font-medium hover:bg-gray-900 focus:outline-none disabled:cursor-not-allowed disabled:bg-gray-300">{isPending ? "Registering..." : "Register"}</button>

                <p className="text-center text-xs text-gray-600">Have an Account?{" "}<Link href={"/signin"} className="text-blue-400 hover:text-blue-600">Login</Link></p>
